...
$(document).ready(function(){
    ...
    // Multi Select Banner
    $(".js-example-basic-multiple-banner").select2({
        placeholder: "Select Banner",
        maximumSelectionLength: 5
    });

    $(".js-example-basic-single-store-tag").select2({
        placeholder: "Select Tag"
    });

    $(".js-example-basic-multiple-store-event").select2({
        placeholder: "Select Event"
    });

    // Multi Select Tag
    $(".js-example-basic-multiple-tag").select2({
        placeholder: "Select Tag"
    });
